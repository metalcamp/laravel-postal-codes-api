...
class PostalCodeTest extends TestCase
{
    ...
    /** @test */
    public function auth_required_when_creating_single_postal_code()
    {
        $postalCode = factory(PostalCode::class)->make();
    ...
    public function it_cannot_create_postal_code_with_same_code()
    {
        ...
        $response   = $this->login()
            ->postJSON("/api/v1/postal-codes", $postalCode->toArray());
    ...
    /** @test */
    public function auth_required_when_updating_single_postal_code()
    {
        $postalCode = factory(PostalCode::class)->create();
        $response   = $this->putJSON("/api/v1/postal-codes/{$postalCode->id}", $postalCode->toArray());
        $response->assertStatus(401)
            ->assertJson(
                [
                    'message' => 'Unauthenticated.',
    ...
    public function it_returns_validation_error_when_updating_single_postal_code()
    {
        $postalCode = factory(PostalCode::class)->create();
        $response   = $this->login()
            ->putJSON("/api/v1/postal-codes/{$postalCode->id}", []);
        ...
        $response = $this->login()
            ->putJSON("/api/v1/postal-codes/{$postalCode->id}", ['code' => 't', 'city_id' => 9999]);
    ...
    public function it_cannot_update_postal_code_to_duplicate_code()
    {
        ...
        $response           = $this->login()
            ->putJSON("/api/v1/postal-codes/{$postalCode->id}", $originalPostalCode->toArray());
    ...
    public function it_can_create_duplicate_postal_code_in_different_city()
    {
        ...
        $response           = $this->login()
            ->postJSON("/api/v1/postal-codes/{$postalCode->id}", $originalPostalCode->toArray());
    ...
    /** @test */
    public function auth_required_when_deleting_single_postal_code()
    {
        $postalCode = factory(PostalCode::class)->create();
    ...
    public function it_can_delete_single_postal_code()
    {
        $postalCode = factory(PostalCode::class)->create();
        $response   = $this->login()
            ->deleteJSON("/api/v1/postal-codes/{$postalCode->id}");
