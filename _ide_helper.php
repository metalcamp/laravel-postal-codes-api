 ...
 * Generated for Laravel 7.5.2 on 2020-04-13 14:20:36.
 *
...
namespace App {
    ...
    * @method \Illuminate\Database\Eloquent\Collection|Province[]|Province make($attributes = [])
    */
    class ProvinceFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Country[]|Country create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Country[]|Country make($attributes = [])
    */
    class CountryFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
...
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|City[]|City create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|City[]|City make($attributes = [])
    */
    class CityFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
